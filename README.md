...
```csharp
var body =
    new CheckRequestParams(tupleKey: new TupleKey("document:project-roadmap", "editor", "anne"));
...
```csharp
var body = new ExpandRequestParams(new TupleKey("document:project-roadmap", "editor"));
...
var body = new ReadRequestParams(new TupleKey("document:project-roadmap", "editor", "anne"));
...
If you have found a bug or if you have a feature request, please report them at this repository [issues](https://github.com/openfga/dotnet-sdk/issues) section. Please do not report security vulnerabilities on the public GitHub issue tracker.
