...
public class RequestBuilder {
    ...
    public string BuildPathString() {
        if (PathTemplate == null) {
            throw new OpenFgaRequiredParamError("RequestBuilder.BuildUri", nameof(PathTemplate));
        }
    ...
    public Uri BuildUri() {
        if (BasePath == null) {
            throw new OpenFgaRequiredParamError("RequestBuilder.BuildUri", nameof(BasePath));
        }
    ...
    public HttpRequestMessage BuildRequest() {
        if (Method == null) {
            throw new OpenFgaRequiredParamError("RequestBuilder.BuildRequest", nameof(Method));
        }
