...
namespace OpenFga.Sdk.Model {
    ...
    public partial class AbortedMessageResponse : IEquatable<AbortedMessageResponse>, IValidatableObject {
        ...
        public AbortedMessageResponse(string code = default(string), string message = default(string)) {
            this.Code = code;
        ...
        public override bool Equals(object input) {
            ...
            return Equals((AbortedMessageResponse)input);
        }
        ...
        private bool ArePropertiesEqual(AbortedMessageResponse input) {
        ...
        private bool AreAdditionalPropertiesEqual(AbortedMessageResponse input) {
