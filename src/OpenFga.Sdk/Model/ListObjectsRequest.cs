...
namespace OpenFga.Sdk.Model {
    ...
    public partial class ListObjectsRequest : IEquatable<ListObjectsRequest>, IValidatableObject {
        ...
        public ListObjectsRequest(string authorizationModelId = default, string type = default, string relation = default, string user = default, ContextualTupleKeys contextualTuples = default, Object context = default, ConsistencyPreference? consistency = default) {
