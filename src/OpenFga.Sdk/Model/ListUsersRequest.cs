...
namespace OpenFga.Sdk.Model {
    ...
    public partial class ListUsersRequest : IEquatable<ListUsersRequest>, IValidatableObject {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((ListUsersRequest)input);
        }
        ...
        private bool ArePropertiesEqual(ListUsersRequest input) {
            ...
            if (!IsCollectionPropertyEqual(this.UserFilters, input.UserFilters)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(ListUsersRequest input) {
