...
namespace OpenFga.Sdk.Model {
    ...
    public partial class CheckRequestParams : IEquatable<CheckRequestParams>, IValidatableObject {
        ...
        public CheckRequestParams(TupleKey? tupleKey = default(TupleKey), ContextualTupleKeys? contextualTuples = default(ContextualTupleKeys), string? authorizationModelId = default(string)) {
