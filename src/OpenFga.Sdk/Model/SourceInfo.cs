...
namespace OpenFga.Sdk.Model {
    ...
    public partial class SourceInfo : IEquatable<SourceInfo>, IValidatableObject {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((SourceInfo)input);
        }
        ...
        private bool ArePropertiesEqual(SourceInfo input) {

            if (!IsPropertyEqual(this.File, input.File)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(SourceInfo input) {
