...
namespace OpenFga.Sdk.Model {
    ...
    public partial class ExpandResponse : IEquatable<ExpandResponse>, IValidatableObject {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((ExpandResponse)input);
        }
        ...
        private bool ArePropertiesEqual(ExpandResponse input) {

            if (!IsPropertyEqual(this.Tree, input.Tree)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(ExpandResponse input) {
