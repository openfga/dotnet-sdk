...
public enum TypeName {
    ...
    TypeName_UNSPECIFIED = 1,

    /// <summary>
    ///     Enum ANY for value: TYPE_NAME_ANY
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_ANY")] TypeName_ANY = 2,

    /// <summary>
    ///     Enum BOOL for value: TYPE_NAME_BOOL
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_BOOL")] TypeName_BOOL = 3,
    ...
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_INT")] INT = 5,

    /// <summary>
    ///     Enum UINT for value: TYPE_NAME_UINT
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_UINT")] UINT = 6,
    ...
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_MAP")] MAP = 10,

    /// <summary>
    ///     Enum LIST for value: TYPE_NAME_LIST
    /// </summary>
    [EnumMember(Value = "TYPE_NAME_LIST")] LIST = 11,
