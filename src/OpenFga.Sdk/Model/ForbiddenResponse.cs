...
namespace OpenFga.Sdk.Model {
    ...
    public partial class ForbiddenResponse : IEquatable<ForbiddenResponse>, IValidatableObject {
        ...
        public ForbiddenResponse(AuthErrorCode? code = default(AuthErrorCode?), string message = default(string)) {
            this.Code = code;
        ...
        public override bool Equals(object input) {
            ...
            return Equals((ForbiddenResponse)input);
        }
        ...
        private bool ArePropertiesEqual(ForbiddenResponse input) {
        ...
        private bool AreAdditionalPropertiesEqual(ForbiddenResponse input) {
