...
namespace OpenFga.Sdk.Model {
    ...
    public partial class Tuple : IEquatable<Tuple>, IValidatableObject {
        ...
        private bool ArePropertiesEqual(Tuple input) {

            if (!IsPropertyEqual(this.Key, input.Key)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(Tuple input) {
