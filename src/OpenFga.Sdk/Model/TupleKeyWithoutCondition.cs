...
namespace OpenFga.Sdk.Model
{
    ...
    public partial class TupleKeyWithoutCondition : IEquatable<TupleKeyWithoutCondition>, IValidatableObject
    {
        ...
        public TupleKeyWithoutCondition(string user = default, string relation = default, string varObject = default)
        {
            ...
            if (varObject == null)
            {
                throw new ArgumentNullException("varObject is a required property for TupleKeyWithoutCondition and cannot be null");
            }
        ...
        public override bool Equals(object input)
        {
            ...
            return this.Equals((TupleKeyWithoutCondition)input);
        }
