...
namespace OpenFga.Sdk.Model {
    ...
    public partial class BatchCheckRequest : IEquatable<BatchCheckRequest>, IValidatableObject {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((BatchCheckRequest)input);
        }
        ...
        private bool ArePropertiesEqual(BatchCheckRequest input) {

            if (!IsCollectionPropertyEqual(this.Checks, input.Checks)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(BatchCheckRequest input) {
