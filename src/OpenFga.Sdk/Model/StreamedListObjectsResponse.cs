...
namespace OpenFga.Sdk.Model {
    ...
    public partial class StreamedListObjectsResponse : IEquatable<StreamedListObjectsResponse>, IValidatableObject {
        ...
        public StreamedListObjectsResponse(string _object = default) {
            // to ensure "_object" is required (not null)
            if (_object == null) {
                throw new ArgumentNullException("_object is a required property for StreamedListObjectsResponse and cannot be null");
            }
            this.Object = _object;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        public bool Equals(StreamedListObjectsResponse input) {
            ...
            return
                ...
                && (this.AdditionalProperties.Count == input.AdditionalProperties.Count && this.AdditionalProperties.All(kv => input.AdditionalProperties.TryGetValue(kv.Key, out var value) && Equals(kv.Value, value)));
        }
