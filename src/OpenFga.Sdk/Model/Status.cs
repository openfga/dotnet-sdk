...
namespace OpenFga.Sdk.Model {
    ...
    public partial class Status : IEquatable<Status>, IValidatableObject {
        ...
        private bool ArePropertiesEqual(Status input) {
            ...
            if (!IsCollectionPropertyEqual(this.Details, input.Details)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(Status input) {
