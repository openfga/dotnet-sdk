...
namespace OpenFga.Sdk.Model {
    ...
    public partial class BatchCheckSingleResult : IEquatable<BatchCheckSingleResult>, IValidatableObject {
        ...
        public BatchCheckSingleResult(bool allowed = default(bool), CheckError error = default(CheckError)) {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((BatchCheckSingleResult)input);
        }
        ...
        private bool ArePropertiesEqual(BatchCheckSingleResult input) {

            if (!IsPropertyEqual(this.Allowed, input.Allowed)) {
                return false;
            }

            if (!IsPropertyEqual(this.Error, input.Error)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(BatchCheckSingleResult input) {
        ...
        public override int GetHashCode() {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Error != null) {
                    hashCode = (hashCode * 9923) + this.Error.GetHashCode();
                }
