...
namespace OpenFga.Sdk.Model {
    ...
    public partial class Nodes : IEquatable<Nodes>, IValidatableObject {
        ...
        private bool ArePropertiesEqual(Nodes input) {

            if (!IsCollectionPropertyEqual(this._Nodes, input._Nodes)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(Nodes input) {
