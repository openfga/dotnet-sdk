...
namespace OpenFga.Sdk.Model {
    ...
    public partial class BatchCheckResponse : IEquatable<BatchCheckResponse>, IValidatableObject {
        ...
        public override bool Equals(object input) {
            ...
            return Equals((BatchCheckResponse)input);
        }
        ...
        private bool ArePropertiesEqual(BatchCheckResponse input) {

            if (!IsCollectionPropertyEqual(this.Result, input.Result)) {
                return false;
            }
        ...
        private bool AreAdditionalPropertiesEqual(BatchCheckResponse input) {
