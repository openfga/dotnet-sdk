...
namespace OpenFga.Sdk.Model {
    ...
    /// </summary>
    [DataContract(Name = "CheckRequestTupleKey")]
    public partial class CheckRequestTupleKey : IEquatable<CheckRequestTupleKey>, IValidatableObject {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckRequestTupleKey" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        public CheckRequestTupleKey(string user = default(string), string relation = default(string), string _object = default(string)) {
            // to ensure "user" is required (not null)
            if (user == null) {
                throw new ArgumentNullException("user is a required property for CheckRequestTupleKey and cannot be null");
            }
            this.User = user;
            // to ensure "relation" is required (not null)
            if (relation == null) {
                throw new ArgumentNullException("relation is a required property for CheckRequestTupleKey and cannot be null");
            }
            this.Relation = relation;
            // to ensure "_object" is required (not null)
            if (_object == null) {
                throw new ArgumentNullException("_object is a required property for CheckRequestTupleKey and cannot be null");
            }
            this.Object = _object;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        /// <summary>
        /// Builds a CheckRequestTupleKey from the JSON string presentation of the object
        /// </summary>
        /// <returns>CheckRequestTupleKey</returns>
        public static CheckRequestTupleKey FromJson(string jsonString) {
            return JsonSerializer.Deserialize<CheckRequestTupleKey>(jsonString) ?? throw new InvalidOperationException();
        }
        ...
        public override bool Equals(object input) {
            ...
            return Equals((CheckRequestTupleKey)input);
        }

        /// <summary>
        /// Returns true if CheckRequestTupleKey instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckRequestTupleKey to be compared</param>
        /// <returns>Boolean</returns>
        ...
        private bool ArePropertiesEqual(CheckRequestTupleKey input) {
        ...
        private bool AreAdditionalPropertiesEqual(CheckRequestTupleKey input) {
