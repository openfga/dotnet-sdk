...
namespace OpenFga.Sdk.Model {
    ...
    public partial class ReadAuthorizationModelResponse : IEquatable<ReadAuthorizationModelResponse>, IValidatableObject {
        ...
        public ReadAuthorizationModelResponse(AuthorizationModel authorizationModel = default) {
        ...
        public override bool Equals(object input) {
            ...
            return this.Equals((ReadAuthorizationModelResponse)input);
        }
        ...
        public override int GetHashCode() {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AuthorizationModel != null) {
                    hashCode = (hashCode * FgaConstants.HashCodeMultiplierPrimeNumber) + this.AuthorizationModel.GetHashCode();
                }
