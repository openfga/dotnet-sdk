...
public class OpenFgaApiError : ApiException {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenFgaApiError"/> class.
    /// </summary>
    public OpenFgaApiError() {
    }
    ...
    public OpenFgaApiError(string message) : base(message) {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="OpenFgaApiError"/> class with a specified error message
    /// and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    /// <param name="message">The error message that explains the reason for the exception.</param>
    /// <param name="innerException">The exception that is the cause of the current exception, or a null
    /// reference if no inner exception is specified.</param>
    public OpenFgaApiError(string message, Exception innerException)
    ...
    /// <param name="innerException">The exception that is the cause of the current exception, or a null
    /// reference if no inner exception is specified.</param>
    public OpenFgaApiError(HttpStatusCode statusCode, string message, Exception innerException)
        : base(message, innerException) {
    ...
    public OpenFgaApiError(HttpStatusCode statusCode, ApiErrorParser? apiError = null)
    ...
    /// <param name="apiError">Optional <see cref="ApiErrorParser"/> of the failing API call.</param>
    public OpenFgaApiError(HttpResponseMessage response, HttpRequestMessage request, string? apiName, ApiErrorParser? apiError = null)
    ...
    internal static async Task<OpenFgaApiError> CreateAsync(HttpResponseMessage response, HttpRequestMessage request, string? apiName) {
        return new OpenFgaApiError(response, request, apiName, await ApiErrorParser.Parse(response).ConfigureAwait(false));
    }
}