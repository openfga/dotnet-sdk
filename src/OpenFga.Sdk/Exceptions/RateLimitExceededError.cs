...
public class OpenFgaApiRateLimitExceededError : OpenFgaApiError {
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OpenFgaApiRateLimitExceededError"/> class with a specified
    /// </summary>
    /// <param name="response"></param>
    /// <param name="request"></param>
    /// <param name="apiName"></param>
    /// <param name="apiError"></param>
    public OpenFgaApiRateLimitExceededError(HttpResponseMessage response, HttpRequestMessage request, string? apiName,
    ...
    internal new static async Task<OpenFgaApiError> CreateAsync(HttpResponseMessage response, HttpRequestMessage request, string? apiName) {
        return new OpenFgaApiRateLimitExceededError(response, request, apiName,
